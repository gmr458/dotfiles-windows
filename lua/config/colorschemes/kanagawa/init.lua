...
kanagawa.setup({
    ...
    overrides = function(colors)
        ...
        return {
            ...
            TelescopePromptNormal = { bg = transparent and "none" or theme.ui.bg_p1 },
            TelescopePromptBorder = {
                fg = transparent and theme.ui.float.fg_border or theme.ui.bg_p1,
                bg = transparent and "none" or theme.ui.bg_p1,
            },
            TelescopeResultsNormal = { fg = theme.ui.fg_dim, bg = transparent and "none" or theme.ui.bg_m1 },
            TelescopeResultsBorder = {
                fg = transparent and theme.ui.float.fg_border or theme.ui.bg_m1,
                bg = transparent and "none" or theme.ui.bg_m1,
            },
            TelescopePreviewNormal = { bg = transparent and "none" or theme.ui.bg_dim },
            TelescopePreviewBorder = {
                bg = transparent and "none" or theme.ui.bg_dim,
                fg = transparent and theme.ui.float.fg_border or theme.ui.bg_dim,
            },
